...
import { UserState, setShowAuthModal, setUserName } from "../redux/reducers/UserReducer";
    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters sx={{display:'flex', justifyContent:'space-between'}}>
          ...
          <Box sx={{display :'flex', flexDirection:'row'}}>
            {userName && <Typography sx={{ marginRight: '20px', fontSize: '20px', fontWeight: 'bold', alignSelf: 'center'}}>{userName}</Typography>}
              ...
              >
                {
                  ...
                  </MenuItem></>) : (<MenuItem onClick={() => {handleCloseUserMenu(); dispatch(setShowAuthModal(true));}}>
